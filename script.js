const thoughts = ["I feel so unwanted sometimes.",
...
function generateThoughts() {
    ...
    document.getElementById("show-usernames").innerHTML = usernames[usernameNumber]

    var imageNumber = Math.floor(Math.random()*(65))
    document.getElementById("show-iamge").src = `assets/peoplepics/${imageNumber}.jpg`;
}
